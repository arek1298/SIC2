...
<center>
  ...
  <a class="btn btn-warning" href="externa-seguridad.php" role="button" style="width: 70px; height: 50px; color: black; align-content: right:"><i class="fas fa-eraser fa-2x"></i></a></center>
...
<a href="externa-seguridad.php" class="select">Seguridad e higiene</a><br>
