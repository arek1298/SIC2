...
<p>
  ...
  <center>
    ...
    <a class="btn btn-warning" href="externa-medicina.php" role="button" style="width: 70px; height: 50px; color: black; align-content: right:"><i class="fas fa-eraser fa-2x"></i></a></center>
...
<a href="externa-medicina.php" class="select">Medicina del trabajo</a><br>
...
<input type="hidden" name="servicio" value="Medicina del trabajo">
...
<select name="tema" required >
                    <option value=""  class="sel">Agregar tema</option>
                    <option value="Expediente-Copia certificada">Expediente/(Copia certificada)</option>
                    <option value="Estudios">Estudios</option>
                    <option value="RT09-Original">RT09-Original</option>
                    <option value="RT09-Copia">RT09-Copia</option>
                    <option value="Terciarias">Terciarias</option>
