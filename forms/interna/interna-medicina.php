...
<center>
  ...
  <a class="btn btn-warning" href="interna-medicina.php" role="button" style="width: 70px; height: 50px; color: black; align-content: right:"><i class="fas fa-eraser fa-2x"></i></a></center>
...
<a href="interna-medicina.php" class="select">Medicina del trabajo</a><br>
