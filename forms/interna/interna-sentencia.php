...
<center>
  ...
  <a class="btn btn-warning" href="interna-sentencias.php" role="button" style="width: 70px; height: 50px; color: black; align-content: right:"><i class="fas fa-eraser fa-2x"></i></a></center>
...
<a href="interna-sentencia.php" class="select">Cumplimiento de sentencia</a><br>
...
<select name="tema" id="opcionees" required>
    ...
    <option value="PENSION POR VIUDEZ">PENSION POR VIUDEZ</option>
    <option value="CUMPLIMIENTO DE SENTENCIA">CUMPLIMIENTO DE SENTENCIA</option>
