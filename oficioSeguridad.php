...
<div class="grid-item"><a href="generarOficio3.php" class="btn btn-info btn-lg active" style="width: 300px; font-size: 22px; height: 115px;">Baja de pension (Gasto Funeral)</a></div>
