...
<div class="respuesta">
<br>
<h2 value="">Petición de documentos <h2 style="color:blue"></h2></h2>
<form action="pdf8.php" method="post">
<br>

           
                <h3>Escribe los datos:  </h3><BR>
                <label>Nombre del juicio o tipo:</label>
         ...
         <label>Fecha:</label>
                ...
                <label>Lugar de promoción (Sala o tribunal):</label>
