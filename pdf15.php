...
<table  width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
       ...
       por medio del cual se requiere rendir informe del cumplimiento a la <b>sentencia de fecha <b> '.$dates2.'</b>  emitida  por la '.$_POST['emitida'].', en los autos del expediente número '.$_POST['numex'].'</b>
